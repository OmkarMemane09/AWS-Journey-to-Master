...
Lifecycle rules help you **manage objects over time** by automating transitions and deletions.  

### 🔀 Transition Actions
Move objects to a cheaper storage class after a defined time. Examples:  
- Move to **Standard-IA** → after 60 days.  
- Move to **Glacier** → after 6 months (archival).  

### ❌ Expiration Actions
Automatically remove objects after a set time. Examples:  
- Delete **access logs** → after 365 days.  
- Delete **old versions** of files.  
- Delete **incomplete multipart uploads**.  

### 🎯 Targeting Rules
- Apply lifecycle rules to **specific prefixes** (folders).  
- Apply lifecycle rules to **objects with tags**.  

![S3 Lifecycle](https://miro.medium.com/v2/resize:fit:720/format:webp/1*oXg3IrJXZ8XqfMR63WWYbA.png)
...
- **Best Practices:**
  ...
  --- make it efficent and good looking also arrange it make it more productive  markdown file which i want to add on github 
